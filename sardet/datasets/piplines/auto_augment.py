...
class RandomRotate(object):
    ...
    def __init__(self,
                 ...
                 prob=0.5,
                 max_rotate_angle=30, rotate_interval=45,
    ...
    def __call__(self, results):
        ...
        interval_nums = 180 // self.rotate_interval
        interval = np.random.choice(interval_nums + 1)
        angle_ = interval * self.rotate_interval
        angle = random_negative(angle_, self.random_negative_prob)
